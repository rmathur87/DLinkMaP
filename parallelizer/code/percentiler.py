...
with open( pval_ptile_0, "w" ) as file0, open( pval_ptile_5, "w" ) as file5:
	...
	for pval_file in pval_files:
		...
		ptile_5_index = math.floor( len( pval_add )*5 / 1000 )

		to_print_file0.append( pval_add[0] )
		to_print_file0.append( pval_dom[0] )
		to_print_file0.append( pval_full[0] )
		to_print_file0.append( pval_main[0] )
		to_print_file0.append( pval_addD[0] )
		to_print_file0.append( pval_domD[0] )
		to_print_file0.append( pval_fullD[0] )
		to_print_file0.append( pval_diet[0] )
